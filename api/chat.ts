...
const getChatSession = () => {
    ...
    if (!chatSession) {
        chatSession = ai.chats.create({
            ...
            config: {
                systemInstruction: `You are the polite and professional AI receptionist for "Professional Razor" (Professional Razor) in Saudi Arabia. 
...
Your job is to provide short, helpful answers, and to book appointments for clients using emojies to make it live. 
