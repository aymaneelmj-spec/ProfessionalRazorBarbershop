...
const fullMenu = [
  { en: "Haircut", ar: "حلقة شعر", price: "SR 60" },
  { en: "Beard Trim", ar: "حلقة ذقن", price: "SR 40" },
  { en: "Haircut + Beard + Wash", ar: "حلقة شعر وذقن وغسيل", price: "SR 115" },

  { en: "Hair Coloring", ar: "صبغة شعر", price: "SR 115" },
  { en: "Beard Coloring", ar: "صبغة ذقن", price: "SR 57.50" },
  { en: "Highlights", ar: "صبغة بسكوتة", price: "SR 40" },
  { en: "Youth Coloring", ar: "صبغة شباب", price: "SR 20" },

  { en: "Face Mask", ar: "ماسك وجه", price: "SR 30" },
  { en: "Steam Facial", ar: "صنفرة مع بخار", price: "SR 50" },
  { en: "Oil Treatment", ar: "حمام زيت", price: "SR 115" },
  { en: "Basic Facial Cleaning", ar: "تنظيف بشرة عادي", price: "SR 115" },
  { en: "Steam Facial + Nose Strip", ar: "صنفرة بخار مع لزقة", price: "SR 70" },

  { en: "Nose Strip", ar: "لزقة أنف", price: "SR 20" },
  { en: "Full Face Wax", ar: "شمع وجه كامل", price: "SR 57.50" },
  { en: "Protein Hair Treatment", ar: "حمام زيت بروتين", price: "SR 170" },
  { en: "Keratin Short Hair", ar: "كيراتين شعر قصير", price: "SR 300" },
  { en: "Keratin Long Hair", ar: "كيراتين شعر طويل", price: "SR 450" },

  { en: "Machine Haircut", ar: "حلقة شعر ماكينة", price: "SR 30" },
  { en: "Full Skin Cleaning", ar: "تنظيف بشرة كامل", price: "SR 185" },
  { en: "Deep Skin Cleaning", ar: "تنظيف بشرة عميق", price: "SR 300" },

  { en: "Manicure", ar: "بديكير لليد", price: "SR 70" },
  { en: "Pedicure", ar: "بديكير للقدم", price: "SR 70" },

  { en: "Full Pedicure", ar: "بديكير كامل", price: "SR 140" },
  { en: "Groom Package", ar: "تجهيز عرسان", price: "SR 400" },
  { en: "VIP Room", ar: "غرفة الـ VIP", price: "SR 600" },

  { en: "Hair Wash", ar: "غسيل شعر", price: "SR 20" },
  { en: "Hair Styling", ar: "استشوار", price: "SR 30" },
  { en: "Nose Wax", ar: "شمع أنف", price: "SR 20" },
  { en: "Ear Wax", ar: "شمع أذن", price: "SR 20" },
  { en: "Tweezers", ar: "صنفرة", price: "SR 20" }
];
        ...
        <footer className="bg-zinc-950 pt-16 pb-8 border-t border-zinc-800 text-zinc-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="flex items-center"><Phone className={`w-5 h-5 shrink-0 ${isRTL ? 'ml-3' : 'mr-3'} text-amber-500`} /> <span dir="ltr" className="font-medium text-zinc-900 dark:text-white tracking-wide">+966 54 442 0003</span></p>
                </div>
              </div>
              <div>
            ...
            <div className="border-t border-zinc-800 pt-8 text-center text-sm text-zinc-500">
              <p>&copy; {new Date().getFullYear()} | Professional Razor Barbershop |. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
